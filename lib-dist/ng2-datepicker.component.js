...
export var DatePickerComponent = (function () {
    ...
    DatePickerComponent.prototype.nameOfweekday = function (index) {
        var locale = (this.options && this.options.locale) ? this.options.locale : "en";
        var additinal = (this.options && this.options.firstWeekdaySunday) ? 6 : 0;
            ...
            this.inputEvents.subscribe(function (e) {
                ...
                if (e.type === 'setDate') {
                    ...
                    _this.value = {
                        ...
                        formatted: date.lang(_this.options.locale).format(_this.options.format),
                        momentObj: date
                    };
                }
            });
    ...
    DatePickerComponent.prototype.generateYears = function () {
        var date = (this.minDate ? this.minDate.clone() : null) || Moment().year(Moment().year() - 40);
        var toDate = (this.maxDate ? this.maxDate.clone() : null) || Moment().year(Moment().year() + 40);
